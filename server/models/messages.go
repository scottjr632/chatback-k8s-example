...
var MessageWhere = struct {
	...
	Username: whereHelperstring{field: "\"messages\".\"username\""},
	Created:  whereHelperstring{field: "\"messages\".\"created\""},
}
...
var (
	messageAllColumns            = []string{"id", "content", "username", "created"}
	messageColumnsWithoutDefault = []string{"content", "username", "created"}
